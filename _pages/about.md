...
My research interests lie in **Model-based and Learning-based Control, Parameter Estimation, and Embodied Intelligence**. My research goal is to build an intelligent robotic system capable of adapting and interacting with its surrounding environment. As a great application of this, I am interested in **humanoid robot** and **medical robot**. 
